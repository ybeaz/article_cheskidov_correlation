...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author[A]{\fnms{First}~\snm{Author} \thanks{[\textbf{Corresponding author indication should be put in the Acknowledgment section if necessary.}]}\ead[label=e1]{first@somewhere.com}},
...
University or Company Name \textbf{[Additional affiliations should be put in the Acknowledgments section]}\printead[presep={ ,\ }]{e1}}
...
\section*{APPENDICES MUST BE MOVED TO A SUPPLEMENT FILE}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
