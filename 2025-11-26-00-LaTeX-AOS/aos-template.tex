...
\kwd{Increment Based Correlation ($\cic$)}
\kwd{\cicFull}
\end{keyword}
...
\caption{Visualization of formula comparison (\pccFull\ and \cicFull) using the running people metaphor} %%%- нужна подпись рисунка
\label{penG}
\end{figure}
